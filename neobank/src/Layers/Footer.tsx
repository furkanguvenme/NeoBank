            ...
            {showAlert && (
              <div className="fixed inset-0 flex items-center justify-center bg-black/50">
                <div className="w-4/5 lg:w-1/5 bg-white p-6 rounded-lg shadow-lg text-center">
                  ...
                  Yapacağınız hesaplamalar ve verdiğim bilgiler, araştırmam doğrultusunda elde ettiğim bilgiler ile hazırlanmıştır. Ancak, sağlanan bilgilerin kesin doğruluğunu garanti edememekteyim. Lütfen önemli kararlar almadan önce bu bilgileri doğrulamayı ihmal etmeyiniz. Ayrıca, bu bilgilerden kaynaklanabilecek herhangi bir hata, eksiklik veya yanlış anlaşılma durumunda hiçbir şekilde sorumluluk veya yükümlülük kabul etmediğimi belirtmek isterim.
                  </p>
                  <button
                    onClick={closeAlert}
