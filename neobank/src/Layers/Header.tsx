  ...
  return (
    <div className="flex flex-row py-4 lg:py-14 items-center w-4/5 h-1/6 justify-between">
      ...
      <nav className="flex flex-row gap-5 lg:gap-10 items-center">
        ...
        <a className="navigation" onClick={() => onClick("#")}>Hakkımda</a>
        <BsInfoSquareFill className="icon" onClick={() => onClick("#")} />
        <a className="navigation" onClick={() => onClick("#")}>İşlemler</a>
        <GiProcessor className="icon" onClick={() => onClick("#")} />
        <a className="navigation" onClick={() => onClick("#")}>İletişim</a>
        <FaPhoneSquareAlt className="icon" onClick={() => onClick("#")} />
      </nav>
    </div>
  );
};
